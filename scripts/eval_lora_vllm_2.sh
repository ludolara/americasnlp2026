#!/usr/bin/env bash
#SBATCH --job-name=2_eval_lora_vllm
#SBATCH --output=logs/eval_lora_vllm_2_output.log
#SBATCH --error=logs/eval_lora_vllm_2_error.log
...
cmd=(
  "$ROOT_DIR/wixarika/bin/python" -m test.eval_lora_vllm_2
